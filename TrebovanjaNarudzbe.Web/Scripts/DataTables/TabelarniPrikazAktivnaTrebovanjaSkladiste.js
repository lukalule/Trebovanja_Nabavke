$(document).ready(function () {
    $('#TabelarniPrikaz').DataTable({
        ...
        "ajax": {
            url: "/Skladiste/ListaAktivnihTrebovanjaZaDT",
            type: 'POST'
        ...
        "columns": [
            ...
            //{ "data": "DatumPodnesenogZahtjeva", "targets": 3 },
            {
    ...
    $('#TabelarniPrikaz tbody').on('click', 'tr', function () {
        ...
        $.get('/Skladiste/AktivnoTrebovanjePartial', data, function (partial) { //vracam objekat trebovanja
