$(function () {
    ...
    function kupljenePodatakaIzFilteraIReload() {
        ...
        window.location.href = '/Nabavke/FilterIstorijaNabavkiKorisnikaIzSektora?SortiranjeDatum=' + sortiranjeDatum + "&SortiranjePoImenu=" + sortiranjePoImenu + "&StatusTrebovanja=" + sortiranjeStatus;
    }
